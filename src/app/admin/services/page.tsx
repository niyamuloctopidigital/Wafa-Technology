  ...
  const handleOpenModal = (service?: Service) => {
    if (service) {
      ...
      setFormData({
        ...
        iconName: service.iconName || (service as any).icon || '',
        features: service.features || [],
        technologies: service.technologies?.join(', ') || '',
        thumbnailUrl: service.thumbnailUrl || (service as any).thumbnail || '',
        bannerImageUrl: service.bannerImageUrl || (service as any).bannerImage || '',
